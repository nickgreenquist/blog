...
**Here is an example of Goodreads recommending a book about the difficult trek to the Western fronteir of the US based on my high rating of the sequel to Charlie and the Chocolate Factory. I think we can do better.**
![Bad Rec]({{ "/assets/Books2Rec/goodreads-charlie.png" | absolute_url }}){:width="300px" .center-image}
*Example of an unrelated recommendation by Goodreads.*
<br><br>

**Below, we are using a hybrid recommender system in order to provide recommendations for Goodreads users (ratings and item features).**
![Good Rec]({{ "/assets/Books2Rec/books2rec-charlie-itemmatrix.png" | absolute_url }}){:width="900px" .center-image}
*Example of our recommendations based on our hybrid model..*
<br><br>

**We also provide more 'traditional' recommendations that only use the book's features.**
![Similar Rec]({{ "/assets/Books2Rec/books2rec-charlie.png" | absolute_url }}){:width="900px" .center-image}
*Example of our recommendations based on pure book metadata features. Notice how it picks up on all the other books from the author despite <code>author</code> not being a feature we included in our model.*
<br><br>
...
### Data Sources
#### Goodbooks 10k
6 million ratings from Goodreads here: [goodbooks-10k repository](https://github.com/zygmuntz/goodbooks-10k). Along with ratings, this data also includes great book metadata that was used for the Content Based Model. 
...
![Good Rec]({{ "/assets/Books2Rec/unnamed-chunk-7-1.png" | absolute_url }}){:width="600px" .center-image}
...
### RapidMiner
[RapidMiner](https://rapidminer.com/) is a Data Science platform that allows for rapid prototyping of Machine Learning algorithms. We used RapidMiner to get a 'feel' for our data. It was great for quickly applying models and seeing their results, but it proved inflexible, and it could not handle more than 12000 users until there was a memory error or an array overflow. They were able to achieve a RMSE of 0.864 and a MAE of 0.685.

![RapidMiner Item Recommendation Process]({{ "/assets/Books2Rec/rapidminer.png" | absolute_url }}){:width="600px" .center-image}
...
There are multiple hyperparameters one can use for training the SVD model. We used Grid Search on the hyperparameter space in order to find the best hyperparameters, with the help of [NYU High Performance Computing](https://wikis.nyu.edu/display/NYUHPC/High+Performance+Computing+at+NYU).
...
![Good Rec]({{ "/assets/Books2Rec/books2rec-start.png" | absolute_url }}){:width="600px" .center-image}
