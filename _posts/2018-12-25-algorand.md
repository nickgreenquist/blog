...
Our code for the 5 steps can be seen below:
[INSERT CODE SNIPPET]

## Implementation
Our goal for the project was to create a working implementation of Algorand based on algorithms described in the Algorand papers [^algorand] [^agreement]. We used the details from [^algorand] to construct our overall structure and our algorithms for sortition, gossiping, and block proposal. We used Algorand Agreement for consensus and used Communication Setting 2 as described above.
...
[INSERT CODE FOR STATE AND PerioD STATE SNIPPET]
...
## Conclusion
What went well, what went bad, what we thought, what we think of algorand, etc.
